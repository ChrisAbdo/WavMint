const Drawer = ({ Web3Handler, account }) => {
  return (
    <div className="flex flex-col justify-between h-screen  border-r border-neutral-content">
      <script
      ...
      ></script>
      <div className="px-4 py-6 border-r  min-h-screen">
        <nav className="flex flex-col mt-6 space-y-1">
          <a href="/" className="btn btn-ghost flex items-center px-4 py-2 ">
            <svg
          ...
          <a href="" className="btn btn-ghost flex items-center px-4 py-2 ">
            ...
            <span className="ml-3 text-sm font-medium"> Step Sequencer </span>
          </a>
          ...
          <a href="" className="btn btn-ghost flex items-center px-4 py-2 ">
            ...
            <span className="ml-3 text-sm font-medium"> Drum Machine </span>
          </a>
          ...
          <details className="group">
            ...
            <nav className="mt-1.5 ml-8 flex flex-col">
              ...
              <a href="" className="flex items-center px-4 py-2 btn btn-ghost ">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-5 h-5 opacity-75"
                  fill="none"
              ...
              <form action="/logout">
                <button
                  type="submit"
                  className="flex items-center w-full px-4 py-2 btn btn-ghost "
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-5 h-5 opacity-75"
